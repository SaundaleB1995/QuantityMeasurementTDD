...
public class QuantityTest {
    ...
    @Test
    public void given0FeetAnd0Litre_ShouldReturnException() {
        try {
            QuantityMeasure feet = new QuantityMeasure(Unit.FEET, 0.0);
        ...
        @Test
    public void given1KilogramAnd0Inch_ShouldReturnException() {
            try {
                QuantityMeasure kiloGram = new QuantityMeasure(Unit.KILOGRAM, 1.0);
                QuantityMeasure inch = new QuantityMeasure(Unit.INCH, 1.0);
    ...
    @Test
    public void given1CelciusAnd1Feet_WhenCompared_ShouldReturnException() {
                try {
                    QuantityMeasure celcius = new QuantityMeasure(Unit.CELCIUS, 1.0);
                    QuantityMeasure feet = new QuantityMeasure(Unit.FEET, 1.0);
                    boolean compareCheck = celcius.compare(feet);
                    Assert.assertTrue(compareCheck);
                } catch (QuantityException e) {
                    Assert.assertEquals(QuantityException.ExceptionType.INVALID_UNIT_TYPE, e.type);
                }
    ...
    @Test
    public void given3KiloGramAnd1Yard_WhenCompared_ShouldReturnException(){
        try {
    ...
    @Test
    public void given1FeetAnd1Centimeter_ShouldReturnException() throws QuantityException {
        QuantityMeasure feet = new QuantityMeasure(Unit.FEET, 1.0);
    ...
    @Test
    public void given1InchAnd1Celcius_WhenCompare_ShouldReturnException() throws QuantityException {
        try {
            QuantityMeasure inch = new QuantityMeasure(Unit.INCH, 1.0);
            QuantityMeasure celcius = new QuantityMeasure(Unit.CELCIUS, 1.0);
    ...
    @Test
    public void given1And36Inch_WhenCompare_ShouldReturnExceptionl() {
        try {
            QuantityMeasure inch = new QuantityMeasure(Unit.INCH, 36.0);
            QuantityMeasure yard = new QuantityMeasure(Unit.YARD, 1.0);
            boolean compareCheck = inch.compare(yard);
        ...
        @Test
    public void given2LitreAnd5Centimeter_WhenCompare_ShouldReturnException()  {
        try {
        ...
        @Test
    public void given2FahrenheitAddWith2Inch_ShouldReturnException() {
        try {
